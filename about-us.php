...
<head>
    ...
    <title>Abount Us | <?php echo $company_title; ?></title>
        ...
        <div class="container">
            <div class="terms-of-service-content">
                ...
                <blockquote class="blockquote">
                    <p>We operate on a B2B2C model by partnering with retail stores to offer Assisted Digital Financial Services such as Aadhaar-enabled payments (Aadhaar ATMs), utility bill payments ( Wallet upload through PG, QR Payment, AEPS pay & Business Loan etc), mobile and DTH recharges, insurance, cash management services (EMI/cash deposits for finance companies, e-commerce platforms, hyper-local delivery services, etc.), payment services like Bharat QR, Indo-Nepal money remittances, travel bookings, and more—all through the comprehensive VillagePe platform. VillagePe, a brand of Gmaxepay Fintech Solutions Pvt Ltd., has become one of the most popular and user-friendly apps over the years. We are committed to delivering an exceptional user experience through our simple and accessible products and services that can be used anytime, anywhere.
                    </p> <br>
                    <p>At VillagePe, our goal is to empower every retail store in Tier I, II, III, and rural areas of India. We offer these stores a window of opportunity to leverage cutting-edge technology and transform VillagePe retail outlets into Fintech Marts.</p>
                </blockquote>
